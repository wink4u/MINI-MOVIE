# Generated by Django 3.2.18 on 2023-05-21 06:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('register_manager', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='register_movies', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
